...
import { HiChevronDoubleDown, HiChevronDoubleUp, HiRefresh } from 'react-icons/hi';
      ...
      <Container maxW="1800px">
          ...
          <Stack gridGap={20} pt={8} direction={['column', 'row']} align="start" mb={6}>
            <Box flex="3">
              ...
              <Text my={3}>
                ...
                playground environment: you can invent and mint new tokens, add and
                withdraw liquidity to pools and play with price and position behaviour.
                The goal is to understand how Decentralized Exchanges like Uniswap, Curve
                or Sushi are working under the hood.
              </Text>
              <Text>
                Since this is all{' '}
        ...
        <Flex gridGap={8}>
          <Button
            ...
            onClick={onToggle}
            my={5}
            leftIcon={isOpen ? <HiChevronDoubleUp /> : <HiChevronDoubleDown />}>
            {isOpen ? 'Collapse' : 'Show intro'}
          </Button>
          <Button
            colorScheme="green"
            variant="link"
